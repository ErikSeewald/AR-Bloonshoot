...
CameraBackground.prototype.initialize = function () {
    ...
    this.app.on(this.permissionEvent, (callback) => {
        ...
        this.app.root.findByName("UI START").enabled = false;
        this.app.root.findByName("UI ERROR").enabled = false;
        ...
        navigator.mediaDevices.getUserMedia(constraints).then(function (stream) {
            ...
            video.addEventListener('canplay', function () {
                ...
                self.app.root.findByName("LEVEL").script.levelLoader.loadLevel();
                self.startVideo();

                self.app.root.findByName("UI TUTORIAL").enabled = true;
            ...
            if (e) self.app.root.findByName("UI ERROR").enabled = true;
